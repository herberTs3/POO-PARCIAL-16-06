...
public class SolicitarReservaDialog extends JDialog {
    ...
    private void cargarEspacios() {
        ...
        ComplejoDeportivo complejo = complejos.get(idx);
        for (EspacioDeportivo e : complejo.obtenerEspacios()) {
    ...
    private void onConfirmar() {
        ...
        try {
            ...
            String codigoEspacio  = (String) cmbEspacio.getSelectedItem();
            codigoEspacio         = codigoEspacio.split(" — ")[0];
